...
// Recore By DaffzOfficial || Andrea
...
${chalk.green.bold("SAITAMA BOT-MD")}         
VERSION 1.00
BOT BY ${chalk.green.bold("DAFFZ")}
...
connectToWhatsApp();
    ...
    nahida.sendMessage('6283820381914' + "@s.whatsapp.net", { text: `👨‍🦲 *SAITAMA-MD berhasil konek*`});
}
